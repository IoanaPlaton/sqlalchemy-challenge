...
# temperature, and the maximum temperature for a specified 
...
# For a specified start date and end date, calculate TMIN,
# TAVG, and TMAX for the dates from the start date to the end date.
